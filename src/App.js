      ...
      <div className="App container">
        <Table striped bordered condensed hover className="colorBlack">
          ...
          <tr>
            <th>#</th>
            <th> Camper Name </th>
            <th onClick={(event)=>this.directionChange(true)}> Points in 30 Days {current &&(<i className="fa fa-caret-down"></i>)} </th>
            <th onClick={(event)=>this.directionChange(false)}> All Time Points {current === false &&(<i className="fa fa-caret-down"></i>)} </th>
          </tr>
          </thead>
          <tbody>
